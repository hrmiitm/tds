...
```text
BIOS --> Turn On Virtulisation
Search --> Turn Windows features on or off
  Virtual Machine Platform, 
  Windows Hypervisor Platform, 
  Windows Subsytem for Linux
	
wsl --list --online           list the available linux os
wsl --install -d <DistroName> insttall the particular linux os
...
::: {.callout-tip}
**Verify:** Open Task Manager → Performance → CPU → Check "Virtualization" is **Enabled**
:::

### 2. Enable Windows Features

**Option A - GUI:**  
- Press `Win + R` → Type `optionalfeatures` → Enable:  
  - ✅ Virtual Machine Platform  
  - ✅ Windows Hypervisor Platform  
...
- ✅ Better for desktop/development use  
- ⚠️ Lower performance (extra OS layer)  
- ⚠️ More overhead  
...
- ⚡ **Fast boot** (under 1 second)  
- 💾 **Dynamic memory** allocation (uses only what's needed)  
- 🔄 **Automatic resource management**
- 🪟 **Deep Windows integration** (filesystem, networking, etc.)  
...
- 🚀 **Performance** - VMs run at near-native speed  
- 🔒 **Security** - Better isolation between VMs  
- ⚡ **Efficiency** - Lower CPU overhead  
- 🎯 **Compatibility** - Required by modern hypervisors  
...
1. ✅ **Hyper-V hypervisor** for lightweight virtualization
2. ✅ **Hardware virtualization** (Intel VT-x / AMD-V) for performance
3. ✅ **Full Linux kernel** for complete compatibility
4. ✅ **Seamless integration** with Windows for productivity
